...
# Load the data
df = pd.read_csv('/mount/src/testing/exercise-ds/dashboard/sleep_health.csv')
...
first_visual[0].plotly_chart(create_pie_chart(metrics, "gender", "Gender", hole=0.4))
first_visual[1].plotly_chart(create_funnel_chart(metrics, column="blood_pressure_category", label="Blood Pressure"))
first_visual[2].plotly_chart(create_pie_chart(metrics, "bmi_category", "BMI"))
